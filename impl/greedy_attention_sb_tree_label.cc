...
struct ParserBuilder {
  ...
  Parameter p_tree_ig_dep_h;
  Parameter p_tree_ig_dep_c;
  Parameter p_tree_ig_bias;

  Parameter p_tree_hfg_rel;
  Parameter p_tree_hfg_head_h;
  Parameter p_tree_hfg_head_c;
  Parameter p_tree_hfg_dep_h;
  Parameter p_tree_hfg_dep_c;
  Parameter p_tree_hfg_bias;

  Parameter p_tree_dfg_rel;
  Parameter p_tree_dfg_head_h;
  Parameter p_tree_dfg_head_c;
  Parameter p_tree_dfg_dep_h;
  Parameter p_tree_dfg_dep_c;
  Parameter p_tree_dfg_bias;
 
  Parameter p_tree_ic_rel;
  Parameter p_tree_ic_head_h;
  Parameter p_tree_ic_dep_h;
  Parameter p_tree_ic_bias;

  Parameter p_tree_og_rel;
  Parameter p_tree_og_head_h;
  Parameter p_tree_og_head_c;
  Parameter p_tree_og_dep_h;
  Parameter p_tree_og_dep_c;
  ...
  explicit ParserBuilder(Model* model, const unordered_map<unsigned, vector<float>>& pretrained) :
      ...
      p_tree_ig_dep_h(model->add_parameters({BILSTM_HIDDEN_DIM*2, BILSTM_HIDDEN_DIM*2})),
      p_tree_ig_dep_c(model->add_parameters({BILSTM_HIDDEN_DIM*2, BILSTM_HIDDEN_DIM*2})),
      ...
      p_tree_hfg_dep_h(model->add_parameters({BILSTM_HIDDEN_DIM*2, BILSTM_HIDDEN_DIM*2})),
      p_tree_hfg_dep_c(model->add_parameters({BILSTM_HIDDEN_DIM*2, BILSTM_HIDDEN_DIM*2})),
      p_tree_hfg_bias(model->add_parameters({BILSTM_HIDDEN_DIM*2})),
      p_tree_dfg_rel(model->add_parameters({BILSTM_HIDDEN_DIM*2, REL_DIM})),
      p_tree_dfg_head_h(model->add_parameters({BILSTM_HIDDEN_DIM*2, BILSTM_HIDDEN_DIM*2})),
      p_tree_dfg_head_c(model->add_parameters({BILSTM_HIDDEN_DIM*2, BILSTM_HIDDEN_DIM*2})),
      p_tree_dfg_dep_h(model->add_parameters({BILSTM_HIDDEN_DIM*2, BILSTM_HIDDEN_DIM*2})),
      p_tree_dfg_dep_c(model->add_parameters({BILSTM_HIDDEN_DIM*2, BILSTM_HIDDEN_DIM*2})),
      p_tree_dfg_bias(model->add_parameters({BILSTM_HIDDEN_DIM*2})),
      ...
      p_tree_ic_dep_h(model->add_parameters({BILSTM_HIDDEN_DIM*2, BILSTM_HIDDEN_DIM*2})),
      ...
      p_tree_og_dep_h(model->add_parameters({BILSTM_HIDDEN_DIM*2, BILSTM_HIDDEN_DIM*2})),
      p_tree_og_dep_c(model->add_parameters({BILSTM_HIDDEN_DIM*2, BILSTM_HIDDEN_DIM*2})),
...
vector<Expression> treeLSTM(ComputationGraph* hg,
	...
	Expression i_tree_ig_dep_h = parameter(*hg, p_tree_ig_dep_h);
	Expression i_tree_ig_dep_c = parameter(*hg, p_tree_ig_dep_c);
	...
	Expression i_tree_hfg_head_h = parameter(*hg, p_tree_hfg_head_h);
        ...
        Expression i_tree_hfg_dep_h = parameter(*hg, p_tree_hfg_dep_h);
        Expression i_tree_hfg_dep_c = parameter(*hg, p_tree_hfg_dep_c);
	...
	Expression i_tree_dfg_head_h = parameter(*hg, p_tree_dfg_head_h);
        Expression i_tree_dfg_head_c = parameter(*hg, p_tree_dfg_head_c);
        Expression i_tree_dfg_dep_h = parameter(*hg, p_tree_dfg_dep_h);
        Expression i_tree_dfg_dep_c = parameter(*hg, p_tree_dfg_dep_c);
        Expression i_tree_dfg_bias = parameter(*hg, p_tree_dfg_bias);
	...
	Expression i_tree_ic_head_h = parameter(*hg, p_tree_ic_head_h);
        Expression i_tree_ic_dep_h = parameter(*hg, p_tree_ic_dep_h);
	...
	Expression i_tree_og_head_h = parameter(*hg, p_tree_og_head_h);
        ...
        Expression i_tree_og_dep_h = parameter(*hg, p_tree_og_dep_h);
        Expression i_tree_og_dep_c = parameter(*hg, p_tree_og_dep_c);
...
if(DEBUG)	std::cerr<<"action lookup ok\n";
	...
	vector<Expression> combination = treeLSTM(hg, head_h, head_c, dep_h, dep_c, relation);
